...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'whitelist.ip' => \App\Http\Middleware\CheckWhitelistedIPs::class,
        'hmac.authenticate' => \App\Http\Middleware\HmacAuthenticate::class,
        'auth.api.key' => \App\Http\Middleware\ApiKeyAuthenticateMiddleware::class,
