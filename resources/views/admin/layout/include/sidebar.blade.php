    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(auth()->user()->user_role == "Client")
                <li class="nav-item">
                    <a class="d-flex align-items-center @if (url()->current() == route('admin.setting.client_list')) active @endif"
            ...
            @can('Settlement')
                ...
                @if($user->user_role == "Super Admin")
                    <li class="nav-item">
                        ...
                        <ul class="menu-content">
                            @foreach(\App\Models\User::where('user_role', 'Client')->where('active', '1')->get() as $activeUser)
                                <li class="@if (url()->current() == route('admin.settlement.show', $activeUser->id)) active @endif nav-item">
                                    <a class="d-flex align-items-center" href="{{ route('admin.settlement.show', $activeUser->id) }}">
                ...
                @else
                    <li class="nav-item">
                        <a class="d-flex align-items-center" href="{{ route('admin.settlement.show', $user->id) }}">
                            <i data-feather="briefcase"></i>
                            <span>Settlement</span>
                        </a>
                    </li>
