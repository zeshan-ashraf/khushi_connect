...
| Variable | Default (this project) | Description |
|----------|------------------------|-------------|
| `API_DOCS_BRAND_NAME` | Khushi Connect | Brand name shown in docs |
| `API_DOCS_BASE_URL` | https://khushiconnect.com/api | API base URL |
| `API_DOCS_LOGO` | assets/img/logo/logo-1.png | Logo asset path |
| `API_DOCS_SUPPORT_EMAIL` | info@khushiconnect.com | Support email |
| `API_DOCS_SERVER_IP` | YOUR_SERVER_IP | Server IP for callback whitelist notice |
...
- `:server_ip` — server IP for callbacks
